...
const Registration = () => {
  ...
  const handleOnSubmit = (e) => {
    ...
    const { username, loginid, password, firstname, lastname,
    zipcode, address, iconimage} = newUser;
          ...
          <Form onSubmit={handleOnSubmit} className="row justify-content-center">
            <Form.Group className="w-50 p-3">
              ...
              <ul className="mb-4">
                <li
                  className={
                    usernameError.isLength ? "text-success" : "text-danger"
                  }
                >
                  Max 8 characters
                </li>
            ...
            <h5 className="p-3">Birthday</h5>
              <Registration_birthday setBirthday={setBirthday} />
            ...
            <Form.Group className="mb-3 p-3">
              <Form.Label as="legend">
                Upload an image file for your icon
              </Form.Label>
            ...
            <Form.Group className="mb-3">
              ...
              {
                offergift === "0" && (
                  <Registration_tags setTaglist={setTaglist} />
                )
                // <Check />
              }
